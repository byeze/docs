...
- Te ayuda a presentar evidencia al banco del propietario de la cuenta para ayudar a resolver la disputa con Inteligencia Artificila.

<small>[1]: La funcionalidad de auto-debit depende del tipo de plan de Kausanna que tengas. Si no tienes auto-debit, debes reembolsar manualmente el monto disputado y la tarifa por disputa a Kausanna.</small>
